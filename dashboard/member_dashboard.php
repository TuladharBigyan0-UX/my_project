...
<div class="dashboard">
    ...
    <aside class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="../php/my_books.php">My Books</a></li>
            <li><a href="../php/browse_books.php">Browse Books</a></li>
            <li><a href="../php/issue_history.php">Issue History</a></li>
            <li><a href="../php/profile_member.php">Profile</a></li>
